...
export const pharmacology: Drug[] = [
  ...
  },
  {
    ...
    "indication": "Hipercolesterolemia, prevenção cardiovascular",
    "mechanism": "Inibe a HMG-CoA redutase, reduzindo a síntese de colesterol",
    "interactions": "Inibidores do CYP3A4 (ex: claritromicina) aumentam risco de miopatia",
    "sideEffects": "Mialgia, elevação de transaminases, rabdomiólise",
    "nursingCare": "Monitorar função hepática e queixas musculares; administrar à noite."
  },
  {
    "name": "Bisoprolol",
    "class": "Betabloqueador cardioseletivo",
    "indication": "Hipertensão, insuficiência cardíaca, angina",
    "mechanism": "Bloqueia receptores beta-1 adrenérgicos no coração",
    "interactions": "Verapamil e diltiazem podem causar bradicardia severa",
    "sideEffects": "Bradicardia, fadiga, broncoespasmo (em altas doses)",
    "nursingCare": "Verificar FC e PA antes da administração; não suspender abruptamente."
  },
  {
    "name": "Dexametasona",
    "class": "Corticosteroide",
    "indication": "Inflamações severas, edema cerebral, COVID-19 grave",
    "mechanism": "Suprime a inflamação e a resposta imune",
    "interactions": "AINEs aumentam risco de úlcera; reduz eficácia de vacinas vivas",
    "sideEffects": "Hiperglicemia, imunossupressão, osteoporose",
    "nursingCare": "Monitorar glicemia; administrar com alimentos para evitar irritação gástrica."
  },
  {
    "name": "Fluoxetina",
    "class": "Antidepressivo (ISRS)",
    "indication": "Depressão, ansiedade, TOC",
    "mechanism": "Inibe a recaptação de serotonina no SNC",
    "interactions": "IMAOs podem causar síndrome serotoninérgica",
    "sideEffects": "Insônia, náusea, disfunção sexual",
    "nursingCare": "Observar risco de suicídio no início do tratamento; administrar pela manhã."
  },
  {
    "name": "Gabapentina",
    "class": "Anticonvulsivante / Analgésico",
    "indication": "Dor neuropática, convulsões parciais",
    "mechanism": "Liga-se a canais de cálcio no SNC, reduzindo liberação de neurotransmissores",
    "interactions": "Antiácidos reduzem sua absorção",
    "sideEffects": "Sonolência, tontura, edema periférico",
    "nursingCare": "Orientar risco de quedas; não suspender abruptamente."
  },
  {
    "name": "Norepinefrina",
    "class": "Vasopressor",
    "indication": "Choque séptico, hipotensão severa",
    "mechanism": "Estimula receptores alfa-1 adrenérgicos, causando vasoconstrição",
    "interactions": "IMAOs e tricíclicos potencializam seus efeitos",
    "sideEffects": "Isquemia periférica, arritmias, necrose tecidual (se extravasamento)",
    "nursingCare": "Administrar em acesso venoso central; monitorar PA continuamente."
  },
  {
    "name": "Pantoprazol",
    "class": "Inibidor da Bomba de Prótons",
    "indication": "Úlcera péptica, DRGE",
    "mechanism": "Inibe a secreção de ácido gástrico",
    "interactions": "Menor interação com clopidogrel que o omeprazol",
    "sideEffects": "Cefaleia, náusea",
    "nursingCare": "Pode ser administrado IV em infusão lenta."
  },
  {
    "name": "Quetiapina",
    "class": "Antipsicótico atípico",
    "indication": "Esquizofrenia, transtorno bipolar",
    "mechanism": "Bloqueia receptores de serotonina e dopamina",
    "interactions": "Inibidores do CYP3A4 aumentam seus níveis",
    "sideEffects": "Sonolência, ganho de peso, hipotensão ortostática",
    "nursingCare": "Orientar sobre risco de quedas ao levantar; monitorar glicemia e lipídios."
  },
  {
    "name": "Risperidona",
    "class": "Antipsicótico atípico",
    "indication": "Esquizofrenia, irritabilidade no autismo",
    "mechanism": "Antagonista de receptores D2 e 5-HT2A",
    "interactions": "Pode antagonizar os efeitos da levodopa",
    "sideEffects": "Aumento de prolactina, ganho de peso, sintomas extrapiramidais",
    "nursingCare": "Monitorar peso e sinais de galactorreia."
  },
  {
    "name": "Sinvastatina",
    "class": "Hipolipemiante",
    "indication": "Hipercolesterolemia",
    "mechanism": "Inibe a HMG-CoA redutase",
    "interactions": "Suco de toranja (grapefruit) aumenta risco de toxicidade",
    "sideEffects": "Mialgia, toxicidade hepática",
    "nursingCare": "Administrar à noite; orientar a relatar dores musculares inexplicáveis."
  },
  {
    "name": "Tramadol",
    "class": "Analgésico opioide fraco",
    "indication": "Dor moderada a intensa",
    "mechanism": "Liga-se a receptores mu-opioides e inibe recaptação de serotonina/noradrenalina",
    "interactions": "ISRS aumentam risco de síndrome serotoninérgica e convulsões",
    "sideEffects": "Náusea, tontura, constipação, risco de convulsão",
    "nursingCare": "Monitorar padrão respiratório e nível de consciência."
  }
];
